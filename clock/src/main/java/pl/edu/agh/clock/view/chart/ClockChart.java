package pl.edu.agh.clock.view.chart;
...
import pl.edu.agh.clock.view.chart.popup.ChartPopup;
import pl.edu.agh.clock.view.chart.selection.SlicesSelectionManager;
import pl.edu.agh.clock.view.chart.selection.SlicesSelectionManager.ISliceSelectionChangeStrategy;
import pl.edu.agh.clock.view.chart.visual.LabelsVisualManager;
import pl.edu.agh.clock.view.chart.visual.SlicesVisualManager;
...
public class ClockChart extends Canvas implements ISizeManagedNode {
	...
	private final SlicesSelectionManager slicesSelectionManager = new SlicesSelectionManager(new ISliceSelectionChangeStrategy() {
		@Override
	...
	public ClockChart(Map<SliceDescriptor, ClockChartData> groupedData, QuantityLevelProvider quantityLevelProvider) {
	...
	private void drawFrame(GraphicsContext graphicsContext) {
		...
		slicesVisualManager.drawFrame(graphicsContext, chartRadius, slicesSelectionManager.getAllSelectedSlices(), getWidth() / 2,
				getHeight() / 2);
