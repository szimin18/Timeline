package clock.view.chart.visual;
...
public final class SlicesVisualManager {
	...
	public void drawFrame(GraphicsContext graphicsContext, double chartRadius, Set<SliceDescriptor> allSelectedSlices,
			double chartMiddleX, double chartMiddleY) {
		...
		for (int currentDayOfWeekIndex = 0; currentDayOfWeekIndex < daysOfWeekCount; currentDayOfWeekIndex++) {
			for (int hour = 0; hour < 24; hour++) {
				...
				drawLine(graphicsContext, chartMiddleX, chartMiddleY, currentInnerRadius, currentOuterRadius, hour - 1,
						lineWidth);
			}
	...
	private void drawChartPart(GraphicsContext graphicsContext, double chartMiddleX, double chartMiddleY,
			double innerRadius, double outerRadius, int hour, Color fillColor) {
	...
	private void drawArc(GraphicsContext graphicsContext, double chartMiddleX, double chartMiddleY, double radius,
