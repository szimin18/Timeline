...
public final class LabelsVisualManager {
	...
	public void drawFrame(GraphicsContext graphicsContext, double chartRadius, double chartMiddleX,
			double chartMiddleY, double fontSize) {
		Font font = new Font(fontSize);
		...
		for (int hour = 0; hour < 6; hour++) {
			...
			double outerTextY = chartMiddleY - chartRadius * MATH_CHART_HELPER.getOffsetSineForHour(transformedHour)
					- chartRadius / 100;
